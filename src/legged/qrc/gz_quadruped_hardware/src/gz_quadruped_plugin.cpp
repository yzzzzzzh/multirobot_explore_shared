...
namespace gz_quadruped_hardware
{
        ...
        sim::EventManager&)
    {
        ...
        // Pass the per-instance node options (params file, remaps) to the
        // controller manager; without this every robot's controller_manager
        // and its controllers start without their parameters when several
        // robots live in one Gazebo process.
